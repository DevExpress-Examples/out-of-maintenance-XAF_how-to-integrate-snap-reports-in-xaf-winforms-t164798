...
namespace SnapModule.Controllers {
    public class DocumentDataController : ViewController {
        ...
        public DocumentDataController() {
            ...
            showDocumentDesignerAction = new SimpleAction(this, "ShowDocumentDesigner", DevExpress.Persistent.Base.PredefinedCategory.Reports);
            ...
            showDocumentPrintPreviewAction = new SimpleAction(this, "ShowDocumentPrintPreview", DevExpress.Persistent.Base.PredefinedCategory.Reports);
            ...
            editDocumentDataAction = new SimpleAction(this, "EditDocumentData", DevExpress.Persistent.Base.PredefinedCategory.Reports);
