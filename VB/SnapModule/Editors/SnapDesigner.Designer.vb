...
Namespace SnapModule.Editors
    Partial Public Class SnapDesigner
        ...
        Private Sub InitializeComponent()
            ...
            Me.snapControl1.MenuManager = Me._ribbon
            ...
            '            Me.snapControl1.ModifiedChanged += New System.EventHandler(Me.snapControl1_ModifiedChanged);
            ' 
            ...
            Me.commandBarGalleryDropDown1.Ribbon = Me._ribbon
            ' 
            ' createLineBaseItem1
            ' 
            ...
            Me.commandBarGalleryDropDown2.Ribbon = Me._ribbon
            ' 
            ' createPieBaseItem1
            ' 
            ...
            Me.commandBarGalleryDropDown3.Ribbon = Me._ribbon
            ' 
            ...
            Me.commandBarGalleryDropDown4.Ribbon = Me._ribbon
            ' 
            ' createAreaBaseItem1
            ' 
            ...
            Me.commandBarGalleryDropDown5.Ribbon = Me._ribbon
            ' 
            ...
            Me.commandBarGalleryDropDown6.Ribbon = Me._ribbon
            ' 
            ...
            Me.commandBarGalleryDropDown7.Ribbon = Me._ribbon
            ' 
            ...
            Me.saveToObjectItem.Glyph = (CType(resources.GetObject("saveToObjectItem.Glyph"), System.Drawing.Image))
            ...
            Me.saveToObjectItem.LargeGlyph = (CType(resources.GetObject("saveToObjectItem.LargeGlyph"), System.Drawing.Image))
            Me.saveToObjectItem.Name = "saveToObjectItem"
            '            Me.saveToObjectItem.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.saveToObjectItem_ItemClick);
            ' 
            ' addXafDataSourceItem
            ' 
            Me.addXafDataSourceItem.Caption = "Add XAF Data Source"
            Me.addXafDataSourceItem.Glyph = (CType(resources.GetObject("addXafDataSourceItem.Glyph"), System.Drawing.Image))
            Me.addXafDataSourceItem.Id = 304
            Me.addXafDataSourceItem.LargeGlyph = (CType(resources.GetObject("addXafDataSourceItem.LargeGlyph"), System.Drawing.Image))
            Me.addXafDataSourceItem.Name = "addXafDataSourceItem"
            '            Me.addXafDataSourceItem.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.addXafDataSourceItem_ItemClick);
            ' 
            ' fileSaveItem1
            ' 
            ...
            Me.editObjectItem.Glyph = (CType(resources.GetObject("editObjectItem.Glyph"), System.Drawing.Image))
            Me.editObjectItem.Id = 307
            Me.editObjectItem.LargeGlyph = (CType(resources.GetObject("editObjectItem.LargeGlyph"), System.Drawing.Image))
            Me.editObjectItem.Name = "editObjectItem"
            '            Me.editObjectItem.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.editObjectItem_ItemClick);
            ' 
            ' newDocumentItem
            ' 
            Me.newDocumentItem.Caption = "New"
            Me.newDocumentItem.Glyph = (CType(resources.GetObject("newDocumentItem.Glyph"), System.Drawing.Image))
            Me.newDocumentItem.Id = 308
            Me.newDocumentItem.LargeGlyph = (CType(resources.GetObject("newDocumentItem.LargeGlyph"), System.Drawing.Image))
            Me.newDocumentItem.Name = "newDocumentItem"
            '            Me.newDocumentItem.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.newDocumentItem_ItemClick);
            ' 
            ...
            Me.snapDocumentManager1.MenuManager = Me._ribbon
            ...
            Me.snapBarController1.RibbonControl = Me._ribbon
            ...
            '            Me.FormClosing += New System.Windows.Forms.FormClosingEventHandler(Me.SnapDesigner_FormClosing);
