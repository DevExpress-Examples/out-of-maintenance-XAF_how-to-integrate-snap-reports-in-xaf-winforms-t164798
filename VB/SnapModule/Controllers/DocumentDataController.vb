...
Namespace SnapModule.Controllers
    Public Class DocumentDataController
        ...
        Public Sub New()
            ...
            showDocumentDesignerAction = New SimpleAction(Me, "ShowDocumentDesigner", DevExpress.Persistent.Base.PredefinedCategory.Reports)
            ...
            showDocumentPrintPreviewAction = New SimpleAction(Me, "ShowDocumentPrintPreview", DevExpress.Persistent.Base.PredefinedCategory.Reports)
            ...
            editDocumentDataAction = New SimpleAction(Me, "EditDocumentData", DevExpress.Persistent.Base.PredefinedCategory.Reports)
        ...
        Private Sub DocumentDataController_ObjectCreating(ByVal sender As Object, ByVal e As ObjectCreatingEventArgs)
            If (Not e.Cancel) AndAlso GetType(IDocumentData).IsAssignableFrom(e.ObjectType) AndAlso Frame.Context <> TemplateContext.LookupControl AndAlso Frame.Context <> TemplateContext.LookupWindow Then
                ...
                Dim documentData As IDocumentData = CType(e.ObjectSpace.CreateObject(e.ObjectType), IDocumentData)
        ...
        Private Sub showDocumentDesignerAction_Execute(ByVal sender As Object, ByVal e As SimpleActionExecuteEventArgs)
            ...
            ShowDesigner(CType(newObjectSpace.GetObject(View.CurrentObject), IDocumentData), newObjectSpace)
        End Sub
        Private Sub ShowDesigner(ByVal documentData As IDocumentData, ByVal objectSpace As IObjectSpace)
            AddHandler objectSpace.Committed, Function() AnonymousMethod1()
        ...
        Private Sub showDocumentPrintPreviewAction_Execute(ByVal sender As Object, ByVal e As SimpleActionExecuteEventArgs)
            Dim newObjectSpace As IObjectSpace = Application.CreateObjectSpace()
            SnapDocumentHelper.ShowPrintPreview(CType(newObjectSpace.GetObject(View.CurrentObject), IDocumentData), newObjectSpace)
        End Sub
        Private Sub editDocumentDataAction_Execute(ByVal sender As Object, ByVal e As SimpleActionExecuteEventArgs)
            ...
            AddHandler e.ShowViewParameters.CreatedView.ObjectSpace.Committed, Function() AnonymousMethod2()
        End Sub
