...
Namespace SnapModule.Controllers
    Public Class InplaceDocumentsController
        ...
        Protected Overrides Sub OnActivated()
            ...
            inplaceDocumentsCacheHelper = New InplaceDocumentsCacheHelper(ObjectSpace, documentDataType)
        ...
        Private Sub documentPrintSelectionAction_Execute(ByVal sender As Object, ByVal e As SingleChoiceActionExecuteEventArgs)
            If TypeOf e.SelectedChoiceActionItem.Data Is IDocumentData Then
                ...
                SnapDocumentHelper.ShowPrintPreview(DirectCast(e.SelectedChoiceActionItem.Data, IDocumentData), Application.CreateObjectSpace(), criteria)
            End If
        End Sub
    End Class
End Namespace
